...
struct FAnimationSetup
{
	...
	unsigned char                                      UnknownData_TXEG[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FAnimationStateEntry
{
	...
	unsigned char                                      UnknownData_3NF5[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0UQY[0x2];                                     // 0x001A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H56M[0x1];                                     // 0x0023(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_013G[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (PADDING)
...
struct FAnimationSharingScalability
{
	...
	unsigned char                                      UnknownData_ZWKQ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_IOCT[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
