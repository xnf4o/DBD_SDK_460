...
struct FNamedInterfaceDef
{
	...
	unsigned char                                      UnknownData_F26A[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FName                                       InterfaceName;                                             // 0x0000(0x000C) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_G5G5[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInAppPurchaseProductRequest
{
	...
	unsigned char                                      UnknownData_OF6V[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FInAppPurchaseProductInfo
{
	...
	unsigned char                                      UnknownData_G7CU[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
