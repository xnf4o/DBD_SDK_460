...
public:
	...
	unsigned char                                      UnknownData_0NIC[0x3];                                     // 0x00F1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VS0X[0x7];                                     // 0x0109(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_NVEH[0x7];                                     // 0x00F1(0x0007) MISSED OFFSET (PADDING)
