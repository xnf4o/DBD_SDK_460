...
struct FAkGeometrySurfaceOverride
{
	...
	unsigned char                                      UnknownData_IVXV[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAkAdvancedInitializationSettings
{
	...
	unsigned char                                      UnknownData_76K5[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DPLL[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IFBR[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAkAdvancedInitializationSettingsWithMultiCoreRendering : public FAkAdvancedInitializationSettings
{
	...
	unsigned char                                      UnknownData_OYSW[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (PADDING)
...
struct FAkHololensAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	unsigned char                                      UnknownData_3TAD[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (PADDING)
...
struct FAkPluginInfo
{
	...
	unsigned char                                      UnknownData_67ID[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAkCommunicationSettings
{
	...
	unsigned char                                      UnknownData_9DM4[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAkCommunicationSettingsWithCommSelection : public FAkCommunicationSettings
{
	...
	unsigned char                                      UnknownData_4CJQ[0x3];                                     // 0x0020(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData_9PL0[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FAkPS4AdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	unsigned char                                      UnknownData_B4MA[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (PADDING)
...
struct FAkPS5AdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	unsigned char                                      UnknownData_COGK[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (PADDING)
...
struct FAkGeometrySurfacePropertiesToMap
{
	...
	unsigned char                                      UnknownData_YW7M[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FAkPoly
{
	...
	unsigned char                                      UnknownData_IZXD[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FAkWindowsAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	bool                                               GlobalFocus;                                               // 0x003C(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                               UseHeadMountedDisplayAudioDevice;                          // 0x003D(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_HF9S[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (PADDING)
...
struct FAkCommunicationSettingsWithSystemInitialization : public FAkCommunicationSettings
{
	...
	unsigned char                                      UnknownData_GWLG[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FAkAndroidAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	unsigned char                                      UnknownData_PXVJ[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (PADDING)
...
struct FAkAudioSession
{
	...
	unsigned char                                      UnknownData_U6JH[0x3];                                     // 0x0000(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_67O7[0x3];                                     // 0x0008(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FAkMainOutputSettings
{
	...
	unsigned char                                      UnknownData_JWM5[0x3];                                     // 0x0014(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_IP6U[0x3];                                     // 0x0018(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_ZM0X[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FAkSpatialAudioSettings
{
	...
	unsigned char                                      UnknownData_70MD[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_U69G[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FAkCommonInitializationSettings
{
	...
	unsigned char                                      UnknownData_CPAQ[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAkCommonInitializationSettingsWithSampleRate : public FAkCommonInitializationSettings
{
	...
	unsigned char                                      UnknownData_LH3Q[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (PADDING)
...
struct FAkWinGDKAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	bool                                               GlobalFocus;                                               // 0x003C(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                               UseHeadMountedDisplayAudioDevice;                          // 0x003D(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_PNN9[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (PADDING)
...
struct FAkXboxOneGDKAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	unsigned char                                      UnknownData_2C86[0x1];                                     // 0x003B(0x0001) MISSED OFFSET (PADDING)
...
struct FAkXboxOneAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	uint16_t                                           MaximumNumberOfXMAVoices;                                  // 0x0038(0x0002) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                               UseHardwareCodecLowLatencyMode;                            // 0x003A(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_Q10A[0x1];                                     // 0x003B(0x0001) MISSED OFFSET (PADDING)
...
struct FAkXSXAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	uint16_t                                           MaximumNumberOfXMAVoices;                                  // 0x0038(0x0002) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                               UseHardwareCodecLowLatencyMode;                            // 0x003A(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_2Z76[0x1];                                     // 0x003B(0x0001) MISSED OFFSET (PADDING)
...
struct FAkAudioEventTrackKey
{
	...
	unsigned char                                      UnknownData_NZ3E[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneTangentDataSerializationHelper
{
	...
	unsigned char                                      UnknownData_B1TT[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneFloatValueSerializationHelper
{
	...
	unsigned char                                      UnknownData_RNML[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneFloatChannelSerializationHelper
{
	...
	unsigned char                                      UnknownData_SV3C[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NIC1[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SQH4[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_DH1Z[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FAkExternalSourceInfo
{
	...
	unsigned char                                      UnknownData_WRCF[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ASJW[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
