...
struct FLuminComponentSubElement
{
	...
	unsigned char                                      UnknownData_OLXL[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLuminComponentElement
{
	...
	unsigned char                                      UnknownData_O956[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
