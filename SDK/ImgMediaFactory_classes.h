...
public:
	...
	unsigned char                                      UnknownData_93AF[0x3];                                     // 0x004D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_V32Y[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FEVF[0x7];                                     // 0x0069(0x0007) MISSED OFFSET (PADDING)
