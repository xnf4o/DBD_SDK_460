...
public:
	...
	unsigned char                                      UnknownData_VIU0[0x4];                                     // 0x0114(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GDS5[0x4];                                     // 0x01F4(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_OHEP[0x20];                                    // 0x0170(0x0020) MISSED OFFSET (PADDING)
