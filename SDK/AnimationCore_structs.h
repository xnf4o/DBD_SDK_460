...
{
	unsigned char                                      UnknownData_XAH9[0x80];                                    // 0x0000(0x0080) MISSED OFFSET (PADDING)
...
struct FAxis
{
	...
	unsigned char                                      UnknownData_F6BI[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FConstraintDescriptor
{
	...
	unsigned char                                      UnknownData_A4LP[0xF];                                     // 0x0001(0x000F) MISSED OFFSET (PADDING)
...
struct FConstraintData
{
	...
	unsigned char                                      UnknownData_CC68[0xB];                                     // 0x0015(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTransformNoScale
{
	...
	unsigned char                                      UnknownData_FGJ0[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_2VOF[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FFilterOptionPerAxis                        AxesFilterOption;                                          // 0x0008(0x0003) (Edit, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_ABK8[0x5];                                     // 0x000B(0x0005) MISSED OFFSET (PADDING)
...
struct FAimConstraintDescription : public FConstraintDescriptionEx
{
	...
	unsigned char                                      UnknownData_P5WM[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTransformConstraintDescription : public FConstraintDescriptionEx
{
	...
	unsigned char                                      UnknownData_S4SU[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FTransformConstraint
{
	...
	unsigned char                                      UnknownData_NOIX[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_S6KC[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (PADDING)
...
struct FConstraintOffset
{
	...
	unsigned char                                      UnknownData_NC0F[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7FMD[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_KIL1[0x38];                                    // 0x0000(0x0038) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8G98[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
