...
struct FCustomizedToolMenuSection
{
	...
	unsigned char                                      UnknownData_U4XU[0x3];                                     // 0x0000(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	Slate_ECustomizedToolMenuVisibility                visibility;                                                // 0x0000(0x0001) ELEMENT_SIZE_MISMATCH (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_OBF5[0x3];                                     // 0x0000(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FInputChord
{
	...
	unsigned char                                      UnknownData_LI6O[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FCustomizedToolMenu
{
	...
	unsigned char                                      UnknownData_SCFP[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Z81O[0xE0];                                    // 0x0110(0x00E0) MISSED OFFSET (PADDING)
